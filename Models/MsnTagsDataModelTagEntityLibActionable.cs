...
namespace MicrosoftNewsAPI.SDK.Models
{
    ...
    public partial class MsnTagsDataModelTagEntityLibActionable
    {
        ...
        public MsnTagsDataModelTagEntityLibActionable(string title = default(string), string type = default(string), string url = default(string), string locale = default(string), string adaptiveCard = default(string), string createdDateTime = default(string), string updatedDateTime = default(string), bool? deleted = default(bool?), string _et = default(string), string id = default(string), string _t = default(string))
        {
            Title = title;
            Type = type;
            Url = url;
